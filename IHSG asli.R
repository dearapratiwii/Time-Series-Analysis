data=read.csv("E:/fd/^JKSE.csv")
data[data$Volume==0,]
data[data$Adj.Close=="null",]
data1=data[-c(251,276,278,283,286,331,25,47,66,76,78,86,107,109,110,111,112,113),]

ihsg=as.numeric(as.character(data1$Adj.Close))
date=as.Date(data1$Date,origin="2019-01-02")
plot(date,ihsg,type="l")
write.table(ihsg,"E:/fd/ihsg.txt")

training=as.ts(ihsg[1:319])
testing=as.ts(ihsg[320:326])          # untuk membandingkan forecast 1 minggu kedepan
testing
lag.plot(training,lags = 25)
